...
public class EcomProjApplication {
  ...
  public static void main(String[] args) {
    ...
    // Cant print trial in here because it has to be a static variable, or else
    // you'll get: Cannot make a static reference to the non-static field trial. If
    // it is a static variable, it'll be null.
  }
